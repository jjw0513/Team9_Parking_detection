...
class ParkingPtsSelection:
    ...
    def save_to_json(self):
        ...
        with open("label_json/bounding_boxes.json", "w") as json_file:
    ...
    def process_data(self, json_data, im0, boxes, clss):
        ...
        for region in json_data:
            ...
            for box, cls in zip(boxes, clss):
                if cls == 0:  # Only consider 'car' class
                ...
                # Draw a circle at the center point of the detected object
                #cv2.circle(im0, (x_center, y_center), radius=5, color=(0, 255, 255), thickness=-1)
